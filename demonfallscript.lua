...
local function startFarming() end -- Função definida depois
...
-- LÓGICA ESP
local espEnabled = false; local activeHighlights = {}; local function updateEsp() end -- Função definida depois
...
-- Redefinição das funções completas aqui para garantir que não se percam
